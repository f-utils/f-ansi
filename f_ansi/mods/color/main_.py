import re
from f_ansi.mods.color.codes_ import ANSI_COLORS, ANSI_STYLES, ANSI_RESET
...
class _Color:
    ...
    def __call__(self, text):
        ...
        return f'\033[{ansi_seq_str}m{text}{ANSI_RESET}'
    ...
    def add_color(self, color_name):
        new_color_code = ANSI_COLORS.get(sanitize_(color_name))
        return _Color(color_code=new_color_code, style_codes=self.style_codes)

    def add_style(self, style_name):
        new_style_code = ANSI_STYLES.get(sanitize_(style_name))
